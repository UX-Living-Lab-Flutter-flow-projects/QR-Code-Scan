...
import 'create_q_rcode3_model.dart';
export 'create_q_rcode3_model.dart';

class CreateQRcode3Widget extends StatefulWidget {
  const CreateQRcode3Widget({
    Key? key,
    required this.qrID,
  }) : super(key: key);
  ...
  @override
  _CreateQRcode3WidgetState createState() => _CreateQRcode3WidgetState();
}

class _CreateQRcode3WidgetState extends State<CreateQRcode3Widget> {
  late CreateQRcode3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateQRcode3Model());
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                _model.apiResultmyaCopy =
                                    await PUTProductCall.call(
                                  qrColor: FFAppState().colorTOAPIString,
                                  id: widget.qrID,
                                  isActive: false,
                                );
                                if ((_model.apiResultmyaCopy?.succeeded ??
                                    true)) {
