...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFF0A2239);
  ...
  late Color success = const Color(0xFF29BF12);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF504E4E);
  late Color accent2 = const Color(0x33000000);
  late Color accent3 = const Color(0xFFFFFFFF);
  late Color accent4 = const Color(0xFF1A1F24);
  late Color success = const Color(0xFF29BF12);
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFFFF0000);
